...
function fnFormatDetails(table_id, html) {
    var sOut = "<table id=\"allclientdb_table_" + table_id + "\" class=\"dataTable\" role=\"grid\">";
    sOut += html;
    sOut += "</table>";
    return sOut;
}
    ...
    //Run On HTML Build
        ...
        TableHtml = $("#allclientdb_table").html();
		//alert("test");
        ...
        alert("checked")
		$('#allclientdb_table tbody input[type="checkbox"]').prop('checked', this.checked);
    });*/

        //Initialse DataTables, with no sorting on the 'details' column
        var oTable = $('#allclientdb_table').dataTable({
